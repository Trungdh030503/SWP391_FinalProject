...
public class maintenanceRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet maintenanceRequest at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Warranty w = wd.getWarrantyBySerialNumber(SerialNumber);
        MaintenanceDAO md = new MaintenanceDAO();
        MaintenanceRequest rq = new MaintenanceRequest();

        rq.setCustomerID(w.getCustomerid());
        rq.setProductID(w.getProductID());
        wd.updateWarranty(SerialNumber, 4);
