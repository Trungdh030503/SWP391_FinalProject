 ...
 * @author Lenovo
 */
public class adminWarranty extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("JobTitle", "admin");
        request.getRequestDispatcher("admin/adminWarranty.jsp").forward(request, response);
