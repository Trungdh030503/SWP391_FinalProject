...
<style>
  /* Tăng kích thước font chữ trong input */
  .form-control {
    font-size: 2em;
  }
  
  /* Tăng chiều cao và độ rộng của input */
  input[type="password"] {
    height: 100px;
    width: 100%;
  }
  ...
  .glyphicon {
    ...
    /* Tăng kích thước của chữ bên cạnh icon */
  .col-sm-6 span {
    font-size: 2em;
  }
  .btn{
      font-size: 2em;
        ...
        <form method="post" action="newPassword">
            ...
            <input type="password" class="input-lg form-control" name="confPassword" id="confPassword" placeholder="Repeat Password" autocomplete="off">
            
            <div class="col-sm-12" style=" font-size: 1.5em">
                    <span id="pwmatch" class="glyphicon glyphicon-remove" style="color:#FF0004"></span> Passwords Match
                </div>
           
            <input type="submit" class="btn btn-primary btn-load btn-lg" data-loading-text="Changing Password..." value="Create Password">
        </form>
        <!--script-->
        <script>
