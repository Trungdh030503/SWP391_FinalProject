    ...
    <head>
        ...
        <script>
            ...
            function doDelete(id)
            {
                ...
                if (c)
                {
                    window.location.href = "delete?CustomerID="+id;
                }
            }
        </script>
    </head>
                                    ...
                                    <c:forEach items="${listSearch}" var="c">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="deleteCustomers?CustomerID=${c.getCustomerID()}" class="delete" data-toggle="modal" onclick="doDelete(${c.getCustomerID()})"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </table>
