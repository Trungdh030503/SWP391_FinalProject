                            ...
                            <div class="card-body p-4">
                                <div class="card-body">
                                    <div class="p-3" id="custom-invoice">
                                        <!-- 5 -->
                                        <form action="createMaintenance" method="POST" id="form">
                                            <div class="invoice-127" id="printableArea">
                                                <div class="row pt-3">
                                                    <h5>
                                                        Request ID: ${id}
                                                        <input type="hidden" class="form-control" name="requestid" value="${id}">
                                                        <input type="hidden" class="form-control" name="customerid" value="${c.getCustomerID()}">
                                                        <input type="hidden" class="form-control" name="productid" value="${p.getProductID()}">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <p>Product details:</p>
                                                        <img class="" src="client/${p.imageURL}" alt="" width="100px">
                                                        <p>${p.getProductName()} </p>
                                                        
                                                    </div>
                                                        <input type="hidden" value="${p.getProductName()}" name="productname">
                                                    <div class="col-md-8">
                                                        Input Fixing Description
                                                        <br> 
                                                        <textarea id="description" rows="5" cols="30" form="form"></textarea>
                                                        <br>
                                                        Input sale price: 
                                                        <input type="number" class="form-control" name="sale" max="${p.getPrice()}">
                                                    </div>
